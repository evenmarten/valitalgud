...
INSERT INTO users (full_name, email, password_hash, phone, role, is_organizer) VALUES
    ('John Doe',       'john.doe@example.com',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '+372 555 1234', 'USER',  FALSE),
    ('Jane Admin',     'admin@example.com',     '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '+372 555 5678', 'ADMIN', TRUE),
    ('Tech Events OÜ', 'organizer@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '+372 555 9999', 'USER',  TRUE),
    ('Alice Smith',    'alice@example.com',     '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '+372 555 1111', 'USER',  FALSE),
    ('Bob Johnson',    'bob@example.com',       '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '+372 555 2222', 'USER',  FALSE);
